This program displays the game in which the user has the ability to build mazes with different difficulty levels, solve the maze and see the results of past games and use previously added maps.
